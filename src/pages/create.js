...
const navigate=useNavigate()
    const onsubmit=(e)=>{
      e.preventDefault()
      axios.post('http://localhost:3030/users/',add)
      .then(res=>{
...
<label>Name:</label>
<input type="text" className="form-control" onChange={e=>setAdd({...add,name:e.target.value})} />
<label>Age</label>
<input type="text" className="form-control" onChange={e=>setAdd({...add,age:e.target.value})} />
